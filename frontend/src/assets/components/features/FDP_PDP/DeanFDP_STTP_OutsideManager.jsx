...
const DeanFDP_STTP_OutsideManager = ({ userRole }) => {
    ...
    const generateExcelReport = async () => {
        ...
        const fileName = isDeptFiltered ? `FDP_STTP_Outside_Report_${deptTitle}.xlsx` : "All_Departments_FDP_STTP_Outside_Report.xlsx";
    ...
    return (
        <div className="std-page-container workshops-container">
            <div className="std-page-header">
                <h2>All Departments FDP/STTP (Outside)</h2>
            </div>

            <div className="achievements-toolbar" style={{ marginTop: '20px' }}>
                <div className="toolbar-text">FDP/STTP Outside Overview</div>
                ...
                <table className="std-table">
                    ...
                    <tbody>
                        {displayedRecords.length === 0 ? (
                            <tr><td colSpan="7" style={{ textAlign: 'center', padding: '20px' }}>No FDP/STTP records found.</td></tr>
                        ) : (
...
export default DeanFDP_STTP_OutsideManager;
